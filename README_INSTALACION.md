# La Porra del Arnomendi v12 online
...
## Actualización v11: resultados reales de partidos

Esta versión añade una columna nueva en Supabase para guardar los resultados reales de los partidos y recalcular automáticamente las clasificaciones de grupo.

Si ya habías ejecutado `database/schema.sql` en la versión anterior, ejecuta ahora solo este archivo en Supabase > SQL Editor:

```txt
database/actualizacion_v11.sql
```

Después vuelve a desplegar la web en Vercel.


## 6. Actualización v12

Se actualiza la lista de jugadores de España para las apuestas de goleador con la convocatoria definitiva de 26 futbolistas.
